...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SharioRestApi.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     */
    //this.basePath = 'http://188.37.120.37:5002/'.replace(/\/+$/, '');
    this.basePath = location.protocol+'//'+location.hostname+(location.port ? ':'+location.port: '') + "/rest_server/";
...
},{"buffer":2,"fs":1,"superagent":6}],10:[function(require,module,exports){
/**
 * Shario REST API
 * API for share-thread-filter REST Server
 *
...
},{"../ApiClient":9,"../model/Error":14}],11:[function(require,module,exports){
/**
 * Shario REST API
 * API for share-thread-filter REST Server
 *
...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the filteredThreadByUserGET operation.
     * @callback module:api/UserApi~filteredThreadByUserGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UserApi~filteredThreadByUserGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Thread}
     */
    this.filteredThreadByUserGET = function(token, threadId, callback) {
      var postBody = null;

      // verify the required parameter 'token' is set
      if (token == undefined || token == null) {
        throw new Error("Missing the required parameter 'token' when calling filteredThreadByUserGET");
      }

      // verify the required parameter 'threadId' is set
      if (threadId == undefined || threadId == null) {
        throw new Error("Missing the required parameter 'threadId' when calling filteredThreadByUserGET");
      }
    ...
    /**
     * Callback function to receive the result of the threadsBriefGET operation.
     * @callback module:api/UserApi~threadsBriefGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} token The user&#39;s token
     * @param {module:api/UserApi~threadsBriefGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Threads}
     */
    this.threadsBriefGET = function(token, callback) {
      var postBody = null;

      // verify the required parameter 'token' is set
      if (token == undefined || token == null) {
        throw new Error("Missing the required parameter 'token' when calling threadsBriefGET");
      }
    ...
    this.userKeywordsGET = function(token, callback) {
      ...
      // verify the required parameter 'token' is set
      if (token == undefined || token == null) {
        throw new Error("Missing the required parameter 'token' when calling userKeywordsGET");
      }
    ...
    /**
     * Callback function to receive the result of the userKeywordsPOST operation.
     * @callback module:api/UserApi~userKeywordsPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OkRes} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UserKeywordsPOSTReq} opts.body request.
     * @param {module:api/UserApi~userKeywordsPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OkRes}
     */
    this.userKeywordsPOST = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];
...
(function(factory) {
  ...
  var exports = {
     ...
     */
    UserKeywordsPOSTReq: UserKeywordsPOSTReq,
    /**
...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SharioRestApi.Error = factory(root.SharioRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';
...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SharioRestApi.LoginRes = factory(root.SharioRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';
  ...
  /**
   * The LoginRes model module.
   * @module model/LoginRes
   * @version 0.0.0
   */

  /**
   * Constructs a new <code>LoginRes</code>.
   * @alias module:model/LoginRes
   * @class
   */
  var exports = function() {
    var _this = this;
  ...
  /**
   * Constructs a <code>LoginRes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LoginRes} obj Optional instance to populate.
   * @return {module:model/LoginRes} The populated <code>LoginRes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SharioRestApi.OkRes = factory(root.SharioRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';
  ...
  /**
   * The OkRes model module.
   * @module model/OkRes
   * @version 0.0.0
   */

  /**
   * Constructs a new <code>OkRes</code>.
   * @alias module:model/OkRes
   * @class
   */
  var exports = function() {
    var _this = this;
  ...
  /**
   * Constructs a <code>OkRes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OkRes} obj Optional instance to populate.
   * @return {module:model/OkRes} The populated <code>OkRes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
...
(function(root, factory) {
  ...
  /**
   * The UserKeywordsPOSTReq model module.
   * @module model/UserKeywordsPOSTReq
   * @version 0.0.0
   */

  /**
   * Constructs a new <code>UserKeywordsPOSTReq</code>.
   * @alias module:model/UserKeywordsPOSTReq
   * @class
   */
  var exports = function() {
    var _this = this;
  ...
  /**
   * Constructs a <code>UserKeywordsPOSTReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserKeywordsPOSTReq} obj Optional instance to populate.
   * @return {module:model/UserKeywordsPOSTReq} The populated <code>UserKeywordsPOSTReq</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
